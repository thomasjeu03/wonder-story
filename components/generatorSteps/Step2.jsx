...
const caracters= [
    ...
    {index: 27, label: 'the-unicorn', value: 'uncicorn', img: '/img/caracters/.27jpg'},
    ...
    {index: 34, label: 'the-alien', value: 'alien', img: '/img/caracters/34.jpg'},  {index: 15, label: 'the-red-panda', value: 'red panda', img: '/img/caracters/15.jpg'},
